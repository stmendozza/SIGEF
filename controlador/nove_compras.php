      ...
      <div class="container-fluid">
        <div class="row">
          <ol class="col breadcrumb">
            ...
            <li class="active">Novedades en Compras</li>
          </ol>
          <button type="button" class="col-5 col-sm-3 btn btn-success" id="registrar-novedad-compra"><span class="fa fa-plus"></span> Registrar Nov. en Compra </button>
          <button type="button" class="col-4 col-sm-2 btn btn-danger" data-toggle="modal" data-target="#buscar_producto"><span class="fa fa-print"></span> Imprimir </button>
          <button type="button" class="col-2 col-sm-1 btn btn-link" ><span class="fa fa-question"></span></button>  
        </div>
        <div class="row">
          <?php include ('paginar_nove_compras.php'); ?>
        </div>                  
      </div>    
    </main>                                                      <!-- Modal -->
    <div class="modal fade" id="novedad-compra" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title" id="myModalLabel"><i class="fa fa-edit"></i> Registrar Novedad en Compra</h4>
          ...
          <div class="modal-body">
            <form class="form-horizontal" method="post" id="guardar_vendedor" name="guardar_vendedor">
              ...
              <div class="form-group">
                ...
                <label for="Descripcion" class="col-2 control-label">Cantidad</label>
                <div class="col-12">
