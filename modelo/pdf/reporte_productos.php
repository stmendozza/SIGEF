<?php           
		...
		// $pdf->AliasNbPage();
		$pdf->AddPage();
		$pdf->Cell(120,5,'Reporte de Productos ',0,1,'L');
		$pdf->SetFillColor(232,232,232);
		$pdf->SetFont('Arial','B',12);
		
		$pdf->Cell(30,6,'CODIGO',1,0,'C',1);
		$pdf->Cell(55,6,'DESCRIPCION',1,0,'C',1);
		...
		$pdf->Cell(30,6,$row['cod_prod'],1,0,'C');
		$pdf->Cell(55,6,utf8_decode($row['descripcion']) ,1,0,'L');
		$pdf->Cell(20,6, $row['precio_costo'],1,0,'C');
		$pdf->Cell(15,6, $row['cantidad'],1,0,'C');
		$pdf->Cell(10,6, $row['cantidad_min'],1,0,'C');
		$pdf->Cell(10,6, $row['cantidad_max'],1,0,'C');
