...
$sql="SELECT cod_clie, nom_usu, telefono_usu, email, direccion_usu FROM  tb_clientes, tb_usuarios WHERE cod_usuario_clie = usuario ORDER BY cod_clie ASC ";
...
$pdf->Cell(120,5,'Listado de Clientes ',0,1,'L');
...

{
	...
	$pdf->Cell(27,6,$row['cod_clie'],1,0,'C');
